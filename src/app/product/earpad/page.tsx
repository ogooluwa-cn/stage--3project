...
export default function WhiteHeadphonePage() {
  ...
  const product = {
    id: 4, // Make sure this ID is unique for this product
    name: "XX59 earphone",
  ...
  const white = () => router.push("/product/headphone");
        ...
        <div className="flex flex-col md:flex-row gap-20 mt-24">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-500 leading-relaxed mb-6">
              Experience unrivalled stereo sound thanks
               to innovative acoustic technology. 
               With improved ergonomics designed for full day wearing, 
               these revolutionary earphones have been finely crafted
                to provide you with the perfect fit, delivering complete 
                comfort all day long while enjoying exceptional noise 
            ...
            <p className="text-gray-500 leading-relaxed">
             ...
             assistants built into both earbuds. The new 7-hour
              battery life can be extended up to 28 hours with the charging case,
               giving you uninterrupted play time. Exquisite craftsmanship with a splash 
               resistant design now available in an all new white and grey color scheme as well as the popular classic black.
          ...
          <div className="flex-1 md:max-w-xs">
            ...
            <ul className="space-y-3 text-gray-600">
              <li>
                <span className="text-orange-500 font-semibold mr-3">1x</span> Earphone Unit
              </li>
              <li>
