...
export default function WhiteSpeakerPage() {
  ...
  const product = {
    id: 7, // Make sure this ID is unique for this product
    name: "ZX9 Speaker",
    ...
    <div className="bg-white">
      ...
      <section className="max-w-6xl mx-auto px-6 py-20">
        ...
        <div className="flex flex-col md:flex-row gap-20 mt-24">
          ...
          This speaker features optical, digital coaxial,
           USB Type-B, stereo RCA, and stereo XLR inputs, 
           allowing you to have up to five wired source devices
            connected for easy switching. Improved bluetooth technology 
            offers near lossless audio quality at up to 328ft (100m).

            </p>
            <p className="text-gray-500 leading-relaxed">
             Discover clear, more natural sounding highs than 
             the competition with ZX9’s signature planar diaphragm 
             tweeter. Equally important is its powerful room-shaking bass
              courtesy of a 6.5” aluminum alloy bass unit. You’ll be able 
              to enjoy equal sound quality whether in a large room or small den. 
              Furthermore, you will experience new sensations from old songs since 
          ...
          <div className="flex-1 md:max-w-xs">
            ...
            <ul className="space-y-3 text-gray-600">
              <li>
                <span className="text-orange-500 font-semibold mr-3">2x</span> Speaker Unit
              </li>
              <li>
                <span className="text-orange-500 font-semibold mr-3">2x</span> Speaker Grille
              </li>
              <li>
              ...
              <li>
                <span className="text-orange-500 font-semibold mr-3">1x</span> 10m Optical Cable
              </li>
            </ul>
          </div>
        </div>
